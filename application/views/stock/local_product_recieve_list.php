	...
	<div class="panel panel-default">
            <div class="panel-heading"><?php echo label_html(LOCAL_PRODUCT_RECEIVED, 'LOCAL_PRODUCT_RECEIVED'); ?></div>
            <div class="panel-body">
                    ...
                    <tbody>
                        <?php $i=1;foreach ($table_data as $data){?>
                          <tr>
                            ...
                            <?php if(($data['status_id']==6 || $data['status_id']==14 || $data['status_id']==5) && ($data['purchase_type_id'] == 4)){?>
                                <a href="<?php echo base_url().'purchase/order_details/'.$data['purchase_id'];?>"><i class="glyphicon glyphicon-eye-open"></i></a>
                            <?php }elseif (($data['status_id']==16 || $data['status_id']==14 || $data['status_id']==5)&& ($data['purchase_type_id'] == 1)) {?>
