            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <span class="label_class" id="CREATE_PURCHASE_ORDER">Create Requisition </span> 
                        <p class="pull-right text-danger rq_generated" style="font-size: 16px;font-style: oblique;padding-right: 24px;"><?php echo (isset($_GET['r_code'])?"Requisition Code : ".$_GET['r_code'].", ":"").(isset($order_id)?'Status : '.$status:''); ?></p>
                    </h5>
                    ...
                    <form class="form-horizontal" id="requisition_frm" action="" method="post">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input required type="date" class="form-control requist_date_for_delivery" id="requist_date_for_delivery" name="request_date_for_delivery" value="<?php echo @$order_info->request_date_for_delivery; ?>" >
                                </div>
                            </div>
                            
                        </div>
                        <div style="padding-right: 15px; margin-right: 250px;">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button module="requisition" type="button" id="add_product"class="btn btn-danger add_products" data-toggle="modal" ><?php echo ADD_ITEM; ?></button>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">Approval Process</h5>
                </div>
                <div class="panel-body">
            ...
            $.ajax({
                ...
                success: function (data) {
                    try {
                        ...
                        htm +='</div>';
                        $('.rq_generated').text('Requisition : '+response.code+", Status : Draft")
                        $('.order_block').html(htm);
                        $('#save_requisition').val('Update Requisition');
                    } catch(e) {
