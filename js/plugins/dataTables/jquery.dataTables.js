...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '&nbsp;&nbsp;<input style="width:70%;" type="search" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		 ...
		 *   allows that property to be changed. You can use Javascript solid
		 ...
		 * property to be changed. You can use Javascript solid object notation to
	...
	DataTable.defaults.column = {
		 ...
		 *    * `.` - solid Javascript notation. Just as you use a `.` in
