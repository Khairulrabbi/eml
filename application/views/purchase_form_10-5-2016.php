    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input required type="text" class="form-control lc_number" id="lc_number" name="lc_number" value="<?php echo @$order_info->lc_number; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lc_value" class="col-lg-3 control-label">LC Value.</label>
                            <div class="col-lg-9">
                                <input required type="number" step="any" class="form-control lc_value" id="lc_value" name="lc_value" value="<?php echo @$order_info->lc_value; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="bill_of_entry" class="col-lg-3 control-label">Bill Of Entry</label>
                            <div class="col-lg-9">
                                <input required type="number" step="any" class="form-control bill_of_entry" id="bill_of_entry" name="bill_of_entry" value="<?php echo @$order_info->bill_of_entry; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input required type="number" step="any" class="form-control bill_of_leading" id="bill_of_leading" name="bill_of_leading" value="<?php echo @$order_info->bill_of_leading; ?>">
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default" style="margin-bottom: 50px;">
                ...
                <div class="panel-body">
                    <div class="col-lg-5"><div class="form-group col-lg-12">
                            <label for="due_date" class="col-lg-5 control-label due_date">Due Date</label>
                            <div class="col-lg-7">
                                <input  type="date" class="form-control due_date" id="order_date" name="due_date" value="<?php echo@$order_info->due_date; ?>" >
                            </div>
                        </div>
                        <div class="form-group col-lg-12">
                            <label for="exchange_rate" class="col-lg-5 control-label exchange_rate">Exchange Rate</label>
                            <div class="col-lg-7">
                                <input type="number" class="form-control exchange_rate" name="exchange_rate" step="any" value="<?php echo @$order_info->exchange_rate; ?>">
                            </div>
                        </div>
                        <div class="form-group col-lg-12">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <label for="taxing_scheme" class="col-lg-5 control-label due_date">Taxing Scheme</label>
                            <div class="col-lg-7">
                                <input  type="text" class="form-control taxing_scheme" id="taxing_scheme" name="taxing_scheme" value="<?php echo @$order_info->taxing_scheme; ?>" >
                            </div>
                        </div>
                        <div class="form-group col-lg-12">
                    ...
                    <div class="form-group col-lg-12"><input type="submit" name="update_order" class="btn btn-primary save" value="Save"></div>
                </div>
