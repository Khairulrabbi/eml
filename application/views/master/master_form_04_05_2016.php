<!-- /.row -->
<style>
    .form-controller{position: absolute;top: -31px;left: 180px;width: 50px;height: 30px;text-align: center;}
    .panel-controller{position: absolute;top: -31px;left: 250px;width: 60px;height: 30px;text-align: center;}
</style>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo ucfirst(str_replace('_', ' ', $view_name)); ?>
            </div>
            <div class="panel-body" style="position:relative;">
                <a class="btn btn-primary form-controller">Add</a>
                ...
                <div class="row">
                    ...
                    <div class="hidden col-lg-<?php echo (3*$form_column).' '.$offset; ?> form-panel">
                    ...
                    <div class="<?php echo $cls ?> grid-div">
                        <div class="panel-body">
                            ...
                            if(!empty($search_panel) || $search_panel != ''){
                                echo '<div class="col-lg-6 search_panel" style="padding-left: 0px;">';
