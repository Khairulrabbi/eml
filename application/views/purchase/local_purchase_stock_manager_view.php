                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table">
						   ...
						   <input type="hidden" name="warehouse_id" value="<?php echo $insert_array['warehouse_id'];?>">
                                <?php 
                                        ...
                                        foreach($product_code as $key=>$value){?>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                ...
                                                <td><?php echo warehouse_list($insert_array['warehouse_id'],array('disabled'=>'disabled'));?></td>
...
<script> 
    ...
    $(document).on("click", "#save", function (e) {
        ...
        //var data = $("#insert_serial_no").serialize();
         var redirectUrl ='<?php echo base_url(); ?>purchase/goods_received';
         var post_field ='order_id';
         var post_value = "<?php echo $insert_array['purchase_id'];?>";
        $.ajax({
            url: '<?php echo base_url(); ?>purchase/local_purchase_insert_serial_no',
            type: 'POST',
