            ...
            <div class="panel panel-default" style="margin-bottom: 50px;">
                ...
                <div class="panel-body">
                    <div class="col-lg-5"><div class="form-group col-lg-12">
                            ...
                            <div class="col-lg-7">
                                <input  type="date" class="form-control due_date" id="order_date" name="due_date" value="<?php echo $due_date; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-lg-7">
                                <input  type="date" class="form-control request_ship_date" id="request_ship_date" name="request_ship_date" value="<?php echo $request_ship_date; ?>" >
                            </div>
                        </div>
                        <div class="form-group col-lg-12">
                            <label for="shipping_method_id" class="col-lg-5 control-label shipping_method_id">Shipping Method</label>
                            <div class="col-lg-7">
                                <?php echo shipping_method($shipping_method_id, array('class' => 'shipping_method_id', '' => '')); ?>
                    ...
                    <div class="col-lg-5">
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-lg-7">
                                <?php echo curency_list($currency_id, array('class' => 'currency_id', '' => '')); ?>
                            </div>
                        </div>
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-lg-7">
                                <input  type="text" class="form-control taxing_scheme" id="taxing_scheme" name="taxing_scheme" value="<?php echo $taxing_scheme; ?>" >
                            </div>
                        </div>
                        <div class="form-group col-lg-12">
