                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <?php echo customer_list($customer_id, array('class' => 'customer_id', 'required' => 'required')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <textarea name="address" id="customer_address" class="form-control address"><?php echo $address; ?></textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                ...
                                <input required type="hidden" class="form-control" id="status" name="sales_status" value="<?php echo $sales_status; ?>" >
                    ...
                    <div class="col-lg-5">
                       ...
                       <div class="form-group col-lg-12">
                        ...
                        <div class="form-group col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <input  type="number" step="any" class="form-control delivery_cost" id="delivery_cost" name="delivery_cost" value="<?php echo $delivery_cost;?>" >
                                    </div>
                                </div>
                        <div class="form-group col-lg-12">
