            ...
            if($rec2['hide_from_input'] !=1 ){
                ...
                switch ($type){
                    case 'select':
                        ...
                        $search_html .= ($rec2['search'] == 1?$slabel_name.form_dropdown($field_name.($is_join==NULL?"":"[]"), $options,$selected_value,'class="form-control"'.$validation.($is_join==NULL?"":" multiple")).'</div>':'');
                        break;
                    case 'var':
                    ...
                    case 'textarea':        
                        $input = "$label_name<textarea $validation name='$field_name' class='form-control'>$selected_value</textarea></div>";
                        $search_html .= ($rec2['search'] == 1?"$slabel_name<textarea $validation name='$field_name' class='form-control'></textarea></div>":'');
                        break;
                    case 'checkbox':
