		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="<?=base_url()?>" style="display: inline-table;padding: 5px 0 0 5px;">
                              <img class="img-responsive" src="<?=base_url()?>images/logo/btrac_logo.png" alt=""/>
                          </a>
			</div>
...
<!-------------------------------------MENU BAR-------------------------------------------------->
        <div class="row" style="background-color:#17BFE6; "></div>
		<div class="row" style="background-color:#0054A6;">
