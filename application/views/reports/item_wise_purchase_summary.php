	...
	<div class="panel panel-default">
            <div class="panel-heading"><?php echo label_html(ITEM_WISE_PURCHASE_SUMMARY, 'ITEM_WISE_PURCHASE_SUMMARY'); ?></div>
            <div class="panel-body">
                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="purchase_list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo label_html(UNIT_COST, 'UNIT_COST'); ?></th>
                            <th><?php echo label_html(NET_COST, 'NET_COST'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i=1;foreach ($sql as $data){
                            $netcost = $data['quantity']*$data['purchase_price'];
                        ?>
                          <tr>
