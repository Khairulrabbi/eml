            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="order_name" class="col-lg-3 control-label">Order Name</label>
                            <div class="col-lg-9">
                                <input  type="text" class="form-control order_name" id="order_name" name="order_name" placeholder="Order Name" value="">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input required type="number" step="any" class="form-control lc_value" placeholder="LC Value" id="lc_value" name="lc_value" value="<?php echo @$order_info->lc_value; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="bill_of_leading" class="col-lg-3 control-label">Bill Of Lading</label>
                            <div class="col-lg-9">
                                <input required type="number" step="any" class="form-control bill_of_leading" placeholder="Bill Of Lading" id="bill_of_leading" name="bill_of_leading" value="<?php echo @$order_info->bill_of_leading; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="" class="col-lg-5 control-label ">LC Statement Duration</label>
                            <div class="col-lg-7">
                                <input  type="text" class="form-control " id="due_date" placeholder="LC Statement Duration" name="lc_statement_duration" value="" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-lg-5 control-label ">LC Statement Date</label>
                            <div class="col-lg-7">
                                <input  type="date" class="form-control due_date" id="due_date" placeholder="Due Date" name="due_date" value="<?php echo@$order_info->due_date; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="currency_id" class="col-lg-5 control-label currency_id">Currency</label>
                            <div class="col-lg-7">
                                <?php echo curency_list(@$order_info->currency_id, array('class' => 'currency_id', '' => '')); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exchange_rate" class="col-lg-5 control-label exchange_rate">Exchange Rate</label>
                            <div class="col-lg-7">
                                <input type="number" class="form-control exchange_rate" placeholder="Exchange Rate" name="exchange_rate" step="any" value="<?php echo @$order_info->exchange_rate; ?>">
                            </div>
                        </div>
                    ...
                    <div style="padding-right: 15px;">
                        <button type="button" id="add_item_button"class="btn btn-primary add_item pull-right" data-toggle="modal" >Add Item</button>
                    </div>        
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default" style="margin-bottom: 50px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-group col-lg-12">
                            <label for="shipping_advice" class="col-lg-5 control-label shipping_advice">Shipping Advice</label>
                            <div class="col-lg-7">
                                <textarea name="shipping_advice" class="form-control"><?php echo @$order_info->shipping_advice; ?></textarea>

                            </div>
                        </div>
                        <div class="form-group col-lg-12">
                            <label for="remarks" class="col-lg-5 control-label remarks">Remarks</label>
                            <div class="col-lg-7">
                    ...
                    <div class="row "></div>
                    <div style="padding-right: 15px;">
                        <input type="submit" name="update_order" class="btn btn-primary save pull-right" value="Save">
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12" style="padding-right: 30px; margin-top: 10px; margin-bottom: 10px">
                                &nbsp;&nbsp;&nbsp;
                                <button class="btn btn-primary search pull-right" style="padding-right: 15px;" >Search</button>
                            </div>
