<form class="form-horizontal" role="form" method="post" id="my_form" action="<?php echo base_url();?>purchase/save_settelment">
     ...
     <input type="hidden" class="purchase_type" name="purchase_type" value="<?php echo $order_info->purchase_type_id; ?>">
                                ...
                                <thead>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style=""><input class="form-control text-right product_price_pay" value="0"></th>
                                        </tr>
                                    </tfoot>
                        </table>   
                        </div>
                                       ...
                                       foreach($cost_component as $key=>$value){
                                        ...
                                        <tr>
                                           <td><?php echo $sl++;?></td>
                                            ...
                                            <td><input class="form-control text-right cost_pay" value="0"></td>
                                        </tr>   
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="field_wrapper">
                            ...
                            <div class="row"></div>
                            <button class="btn btn-primary text-center" style="margin-left: 656px;">Settlement</button>
                        </div>
                    </div>
                </div>
                    </div>
