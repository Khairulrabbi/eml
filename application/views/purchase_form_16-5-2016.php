                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="purchase_order" action="" method="post">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                <label for="lc_value" class="col-lg-4 control-label">LC Value. <span class="text-danger">*</span></label>
                                <div class="col-lg-8">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="" class="col-lg-5 control-label ">LC Settlement Duration <span class="text-danger">*</span></label>
                                <div class="col-lg-7">
                                    <input  type="number" class="form-control " id="lc_settlement_duration" placeholder="LC Settlement Duration" name="lc_settlement_duration" value="<?php echo@$order_info->lc_settlement_duration; ?>" >
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div style="padding-right: 15px;">
                            <button type="button" id="save_purchase"class="btn btn-primary pull-right">Save</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <div class="field_wrapper">
                        <div class="col-lg-8">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label for="" class="col-lg-6 control-label">Cost Component</label>
                                    <div class="col-lg-6">
                            ...
                            <div class="col-lg-5"> 
                                <div class="form-group">
                                    <label for="" class="col-lg-4 control-label">Total Cost</label>
                                    <div class="col-lg-8">
...
<script>
    ...
    $("#save_purchase").on("click",function(){
        ...
        ///alert(order_date);
        if (vendor_id && order_date && lc_number && order_date && bill_of_entry && bill_of_lading && lc_settlement_duration && lc_settlement_date) {
...
//                    $(".order_id").val(data);
    ...
    $('#add_product_m').on('hidden', function() {
       $('#add_product_m').modal('hide').remove();
    });
