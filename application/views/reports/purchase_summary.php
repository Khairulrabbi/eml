	...
	<div class="panel panel-default">
            <div class="panel-heading"><?php echo label_html(PURCHASE_SUMMARY, 'PURCHASE_SUMMARY'); ?></div>
            <div class="panel-body">
                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="purchase_list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo label_html(FREIGHT_CHARGE, 'FREIGHT_CHARGE'); ?></th>
                            <th><?php echo label_html(AMOUNT, 'AMOUNT'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i=1;foreach ($sql as $data){
                            $amount = $data['freight_charge']+$data['amount'];
                        ?>
                          <tr>
                            <td><?php echo $data['po']?></td>
                            <td><?php echo $data['vendor_name']; ?></td>
                            <td><?php echo $data['order_date']; ?></td>
                            <td><?php echo $data['freight_charge']; ?></td>
