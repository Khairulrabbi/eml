                                            ...
                                            <tr>
                                              ...
                                              if($value['quantity']==$value['total_received']){
                                               ...
                                               echo $value['quantity'];?></td>
                                                ...
                                                <td>
                                                    <?php echo ap_drop_down(20,NULL,array("selected_value"=>'')); ?>
                                                    <?php //echo warehouse_list('',array('class'=>'warehouse'));?>
                                                </td>
                                                <td><button type="submit" class="btn btn-primary options"  btn-form="my_form_<?php echo $value['product_id'] ?>" <?php echo $disable_button; ?> >Receive</button></td>
                                            </tr>
                                </form>
                                        <?php } ?>
                            </tbody>
