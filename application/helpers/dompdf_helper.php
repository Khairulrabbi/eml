...
if (!function_exists('do_mpdf_create')) 
{
    ...
    {        
        ...
        $mpdf->SetHeader('    
            <div class=" pull-right" style="margin-right:20px;position; fixed;">
                <img class="img-responsive" style="width:270px;" src="./images/logo/emllogo.png" alt=""/>
                <p>Uttara Centre, 102, Shahid Tajuddin Ahmed Sarani, Tejgaon, Dhaka-1208</p>
                <p>Tel: 02-8170349-50, 8170352, FAX: 02-8170351, E-mial: eml@ugc-bd.net, emlgm@ugc-bd.net</p>
                <h5>Sole Agent: Bridgestone Corporation, Japan</h5>
            </div>
            ');  
        $mpdf->SetHTMLFooter( '<hr>		
                <p style="font-size:8px;"><b style="font-size:10px;">BRIDGESTONE</b> Branches : CTG : Tel: 031-723712,711670 BIJOYNAGAR: Tel: 02-8316615,8351804,BOGRA: Tel:051-78296,JESSORE:Tel: 0421-64009,COXS BAZAR : Tel: 0341-63745</p>
            ' );		
        // write html
