...
<table class="table" id="d_table">
			<thead>
				<tr>
                                    <th><input class="c_box" id="check_all" type="checkbox"></th><th>Product Code</th><th>Serial Number</th>
                                    <th>Vendor Name</th><th> Warranty Start date</th>
                                    <th>WareHouse</th>
				</tr>
			</thead>
			<tbody>
...
<div class="pull-right">
    <button id="release" class="btn btn-primary btn-sm">Release</button>
</div>
<?php } 
else {
?>
<div class='alert alert-warning'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
    <center><strong>Sorry!!!</strong>No allocation available!</center></div>
<?php } ?>
