...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
		...
		if(!isset($message)) {
                    ...
                    unlink('redirect.ini');
                    //echo $redir . 'home/install_success';
                    header( 'Location: ' . $redir . 'home/install_success' ) ;
		}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <center><h1>Project Configuration</h1></center>
    <?php if(is_writable($db_config_path)){?>
        ...
        <fieldset>
		  ...
		  <label for="prefix">Database Prefix</label><input type="text" id="prefix" class="input_text" name="prefix" />
